...
class Config(object):
  ...
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "1003379165829")
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "1003432402350"))
...
"""
  ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: [VJ](https://t.me/+aa7eXw-UgKNhNmJl)
 
 I am Super noob Please Support My Hard Work.

[Donate Me](https://t.me/+aa7eXw-UgKNhNmJl)
"""
  HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
